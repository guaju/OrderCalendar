package com.guaju.ordercalendar.widget;
...
import com.guaju.ordercalendar.R;
import com.guaju.ordercalendar.controller.DatePickerController;
...
//        year = position / MONTHS_IN_YEAR - 1 + calendar.get(Calendar.YEAR);
         //GUAJU
        month=(calendar.get(Calendar.MONTH)+position)%MONTHS_IN_YEAR;
        year =(calendar.get(Calendar.MONTH)+position)/MONTHS_IN_YEAR + calendar.get(Calendar.YEAR);
